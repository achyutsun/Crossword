...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        if (D) MainActivity.debug(1, TAG, "setState() " + mState + " -> " + state);
        mState = state;
    ...
    public synchronized void connect(BluetoothDevice device) {
        if (D) MainActivity.debug(1, TAG, "connect to: " + device);
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        if (D) MainActivity.debug(1, TAG, "connected, Socket Type:" + socketType);
        ...
        Message msg = mHandler.obtainMessage(BluetoothManager.MESSAGE_DEVICE_NAME);
     ...
     * Stop all threads
     */
    public synchronized void stop(boolean disableBT) {
        if (D) MainActivity.debug(1, TAG, "stop");
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            if (D) MainActivity.debug(1, TAG, "Socket Type: " + mSocketType +
        ...
        public void cancel() {
            if (D) MainActivity.debug(1, TAG, "Socket Type" + mSocketType + "cancel " + this);
            try {
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                // Close the socket
                try {
                    Log.e(TAG, "close exception " + mSocketType+ "["+Long.toHexString(getId())+"]");
                    if (!mCancelled)
                    {
                    	mCancelled=true;
                    	mmSocket.close();
        ...
        public void cancel() {
            try {
                Log.e(TAG, "close() of connect " + mSocketType+ "["+Long.toHexString(getId())+"]");
                mCancelled=true;
                mmSocket.close();
            } catch (IOException e) {
